            ...
            <div class="card-body p-4">
                <div class="text-center">
                    <div class="profile-user position-relative d-inline-block mx-auto  mb-4">
                        <img src="<?= $user->avatarUrl ?>" class="rounded-circle avatar-xl img-thumbnail user-profile-image" alt="user-profile-image">
                    ...
                    <h5 class="fs-17 mb-1"><?= $user->fullName ?></h5>
                    <p class="text-muted mb-0"><?= $user->rankTitle ?></p>
                </div>
            </div>
        </div>
        <!--end card-->
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="mb-3 d-flex">
                    ...
                    <input type="text" class="form-control" id="websiteInput" placeholder="www.example.com" value="www.sirius-energy.co">
                </div>
                <div class="mb-3 d-flex">
                    <div class="avatar-xs d-block flex-shrink-0 me-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="websiteInput1" placeholder="www.example.com" value="www.sirius-energy.co" />
                                    </div>
                                </div>
                                <!--end col-->
                                <div class="col-lg-4">
