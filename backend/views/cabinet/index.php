...
<div class="alert alert-warning alert-dismissible fade show partner-notice" role="alert">
    ...
    <strong>⚠ Отдельно предупреждаем:</strong> вас могут склонять к написанию заявлений. Не поддавайтесь на это! Такие действия не приведут к возврату средств — правоохранительные органы не осуществляют выплат инвесторам и используют заявления только для увеличения числа пострадавших в своих отчётах.<br><br>
    Мы официально заявляем:<br>
    <ul>
        <li>Руководство компании на месте;</li>
        <li>Все бизнес-процессы работают в штатном режиме;</li>
        <li>Активы надёжно защищены;</li>
        <li>Все обязательства перед инвесторами будут выполнены в полном объёме в ближайшее время.</li>
    </ul>
