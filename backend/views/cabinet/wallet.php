            ...
            <div class="col-sm-12 col-lg-6 border-end mb-4">
                ...
                <div class="d-flex">
                    ...
                    <div class="ms-3">
                        ...
                        <p>Ref. balance: <span class="text-bg-success text-nowrap py-1 px-2 rounded"><?= number_format($data->RefBalance, 2, '.', ' ') ?> USDT</span></p>
                        <?php if ($data->CashAwait > 0): ?>
                            <p>Waiting for withdrawal:  <span class="text-bg-danger text-nowrap py-1 px-2 rounded"><?= $data->CashAwait ?> USDT</span></p>
                        <?php endif; ?>
                        <hr>
